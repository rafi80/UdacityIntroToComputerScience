...
def is_leap_year(year):
    if (year / 4.0 - floor(year / 4.0)) == 0 and \
            not ( (year / 100.0 - floor(year / 100.0)) == 0 and (year / 400.0 - floor(year / 400.0)) != 0):
        return True
    else:
        return False
...
is_leap_baby(19, 6, 1978)
is_leap_baby(29, 2, 2000)
is_leap_baby(29, 2, 1900)
is_leap_baby(28, 2, 1976)
